...
void FEHL(void (*F)(double t1, const double *y1, double *dy1), int NEQN,
...
void RKFS(void (*F)(double t1, const double *y1, double *dy1), int NEQN,
    ...
    float A = 0, AE = 0, DT = 0, EE = 0, EEOET = 0, ESTTOL = 0, ET = 0, HMIN = 0, REMIN = 0,
